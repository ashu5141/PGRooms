<%@ Page Title="" Language="C#" MasterPageFile="~/pgowner/pgowner2.master" AutoEventWireup="true" CodeFile="editpgdetails.aspx.cs" Inherits="pgowner_editpgdetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="br-mainpanel">
      ...
      <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Edit Your PG Details</h4>
          ...
          <div class="form-layout form-layout-1">  
            <div class="row mg-b-22">
                ...
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">Pg Title: <span class="tx-danger">*</span></label>
               
                <asp:TextBox ID="pgtitle" class="form-control"  runat="server" placeholder="State"></asp:TextBox>
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-4">
                <div class="form-group mg-b-10-force">
