<%@ Page Title="" Language="C#" MasterPageFile="~/pgowner/pgowner2.master" AutoEventWireup="true" CodeFile="PGs2.aspx.cs" Inherits="pgowner_PGs2" %>
      ...
      <%--    OnItemDeleting="lvEmployee_ItemDeleting">--%>
            ...
            <ItemTemplate> 
                ...
                <tr class="TableData"> 
                    ...
                    <td>
                        <asp:Button ID="btnEdit" class="ad-st-view" runat="server" Text="Edit" OnClick="btnEdit_Click" style="border:none"/>
                    </td>
