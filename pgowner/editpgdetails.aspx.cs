...
public partial class pgowner_editpgdetails : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            using (SqlCommand cmd = new SqlCommand("INSERT INTO pgDetails  (state,city,roomtype,noofbeds,rent,address,emailid,contactowner,powerbackup,parking,airconditioner,balcony,laundry,wifi,tv,security,foodavailable,pgtitle) VALUES (@state,@city,@roomtype,@noofbeds,@rent,@address,@emailid,@contactowner,@powerbackup,@parking,@airconditioner,@balcony,@laundry,@wifi,@tv,@security,@foodavailable,@pgtitle)"))
            {
                ...
                cmd.Parameters.AddWithValue("@pgtitle", pgtitle.Text);
                cmd.Connection = con;
                con.Open();
                cmd.ExecuteNonQuery();
                con.Close();
