<%@ Page Title="" Language="C#" MasterPageFile="~/admin/pgowner.master" AutoEventWireup="true" CodeFile="complaint.aspx.cs" Inherits="admin_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="br-mainpanel">
      <div class="pd-30">
        <h4 class="tx-gray-800 mg-b-5">Complaints</h4>
        ...
        <div class="br-section-wrapper">
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Complaints</h6>
          ...
          OnItemDeleting="lvEmployee_ItemDeleting">
            <LayoutTemplate> 
                    ...
                    <tr id="Tr1" runat="server"> 
                        ...
                        <th id="Th2" runat="server">Message</th>  
